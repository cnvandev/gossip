...
class DatagramCallbackProtocol(MulticastDatagramProtocol):
    ...
    callback: Callable[[bytes, IPv4Address | IPv6Address | None, Endpoint, DatagramTransport], Coroutine[Any, Any, None]]

    def __init__(self, callback: Callable[[bytes, IPv4Address | IPv6Address | None, Endpoint, DatagramTransport], Coroutine[Any, Any, None]], loop: AbstractEventLoop | None = None, group_address: str | None = None, interface_address: str | None = None):
    ...
    def datagram_received(self, data: bytes, addr: tuple[str, int]) -> None:
        ...
        future = self.callback(data, self.parsed_address, Endpoint.for_addr(addr), self.transport)
