...
class HTTPAccessor:
    ...
    methods: Mapping[str, Callable[[ResourceCollection, HTTPRequest, Mapping[str, tuple[Any, Mapping[str, str]] | None], Mapping[str, str]], Awaitable[Iterable[HTTPResponse]]]]

    def __init__(self, methods: Mapping[str, Callable[[ResourceCollection, HTTPRequest, Mapping[str, tuple[Any, Mapping[str, str]] | None], Mapping[str, str]], Awaitable[Iterable[HTTPResponse]]]] | None = None):
    ...
    async def access(self, resource: ResourceCollection, request: HTTPRequest, constraints: Mapping[str, tuple[Any, Mapping[str, str]] | None], headers: Mapping[str, str]) -> Iterable[HTTPResponse]:
        ...
        return await caller(resource, request, constraints, headers)

    async def options(self, resource: ResourceCollection, request: HTTPRequest, constraints: Mapping[str, tuple[Any, Mapping[str, str]] | None], static_headers: Mapping[str, str]) -> Iterable[HTTPResponse]:
    ...
    async def head(self, resource: ResourceCollection, request: HTTPRequest, constraints: Mapping[str, tuple[Any, Mapping[str, str]] | None], static_headers: Mapping[str, str]) -> Iterable[HTTPResponse]:
    ...
    async def get(self, resource: ResourceCollection, request: HTTPRequest, constraints: Mapping[str, tuple[Any, Mapping[str, str]] | None], static_headers: Mapping[str, str]) -> Iterable[HTTPResponse]:
    ...
    async def put(self, resource: ResourceCollection, request: HTTPRequest, constraints: Mapping[str, tuple[Any, Mapping[str, str]] | None], static_headers: Mapping[str, str]) -> Iterable[HTTPResponse]:
    ...
    async def patch(self, resource: ResourceCollection, request: HTTPRequest, constraints: Mapping[str, tuple[Any, Mapping[str, str]] | None], static_headers: Mapping[str, str]) -> Iterable[HTTPResponse]:
        """Returns a response for the `PATCH` method."""
        body, metadata = await resource.patch(request.target, constraints, request.body)
        return (HTTPResponse(HTTPStatus.OK, dict(metadata) | dict(static_headers), body),)

    async def delete(self, resource: ResourceCollection, request: HTTPRequest, constraints: Mapping[str, tuple[Any, Mapping[str, str]] | None], static_headers: Mapping[str, str]) -> Iterable[HTTPResponse]:
