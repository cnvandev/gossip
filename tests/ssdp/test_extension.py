...
class TestDiscoverExtensionSearch:
    ...
    async def test_ssdp_all_matches_every_target_on_the_device(self):
        ...
        responses = await DISCOVER.search(resource, request, {}, {}, REMOTE, LOCAL)
    ...
    async def test_an_unrelated_target_matches_nothing(self):
    ...
    async def test_a_response_carries_the_targets_own_metadata(self):
        ...
        (response,) = await DISCOVER.search(resource, request, {}, {}, REMOTE, LOCAL)
    ...
    async def test_missing_st_header_matches_nothing(self):
    ...
    async def test_response_headers_include_the_given_static_headers(self):
        ...
        request = HTTPRequest("SEARCH", STAR_PATH, {"ST": "ssdp:all"})
        responses = await DISCOVER.search(resource, request, {}, {"Server": "gossip"}, REMOTE, LOCAL)
